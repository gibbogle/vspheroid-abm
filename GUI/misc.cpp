...
//    return;
    ...
    for (int i=1; i <= nsteps+1; i++) {
        ...
        if (i%summary_interval == 0) {
            ...
            get_concdata(&Global::conc_axis, &Global::conc_nvars, &Global::conc_nc_ex, &Global::conc_dx_ex, Global::concData);
            get_ic_concdata(&Global::conc_axis, &Global::conc_nvars, &Global::conc_nc_ic, &Global::conc_dx_ic, Global::IC_concData);
