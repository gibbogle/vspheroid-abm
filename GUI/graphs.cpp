...
GRAPH_SET tsGraphSet[] = {
    ...
    {"doublingtime",
     ...
     "/hour",
     "# divided/hour",
     45, false, 0, 1, 0, TS_TYPE},

     {"Pfraction",
     "% pyruvate utilised",
     "%",
     "% pyruvate utilised",
     46, false, 0, 0.1, 0, TS_TYPE},
